...
<footer class="footer">
	<div class="footer-content">
		<p class="m-b-0">Software <?php echo date("Y") ?> Continuous Improvement Software. MMW.</p>
		<span>
			<a href="mailto:msalaza@martechmedical.com" class="text-gray m-r-15">Preguntas y sugerencias</a>
			<a href="mailto:jgomez@martechmedical.com" class="text-gray">Reporta un error</a>
		</span>
	</div>
</footer>
<!-- Footer END -->
